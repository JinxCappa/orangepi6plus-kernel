...
static const struct snd_kcontrol_new rt5682s_sto1_adc1r_mux =
	SOC_DAPM_ENUM("Stereo1 ADC1R Source", rt5682s_sto1_adc1r_enum);
...
static const struct snd_soc_dapm_route rt5682s_dapm_routes[] = {
	...
	{"IF1 ADC Mux", "Slot 0", "IF1 01 ADC Swap Mux"},
	{"IF1 ADC Mux", "Slot 2", "IF1 23 ADC Swap Mux"},
	{"IF1 ADC Mux", "Slot 4", "IF1 45 ADC Swap Mux"},
	{"IF1 ADC Mux", "Slot 6", "IF1 67 ADC Swap Mux"},
	{"ADCDAT Mux", "ADCDAT1", "IF1 ADC Mux"},
	{"AIF1TX", NULL, "I2S1"},
...
static const struct pll_calc_map plla_table[] = {
	...
	{3072000, 49152000, 0, 30, 0, false, false, false, false},
