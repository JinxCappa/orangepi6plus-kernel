 ...
 * @node: device tree node handle (or 0 for non-DT entries)
 * @uname: name of the reserved memory region
 * @base: physical base address
 * @size: size in bytes
 *
 * This function saves a reserved memory entry for later processing.
 * It can be called from DT parsing or ACPI initialization.
 */
