...
/**
 * struct fwnode_genpd_provider - PM domain provider based on fwnode
 * @link: Entry in global list of PM domain providers
 * @fwnode: Pointer to fwnode associated with the PM domain provider
 * @xlate: Provider-specific xlate callback for finding a PM domain
 * @data: Context pointer passed to @xlate callback
 */
...
/* List of registered fwnode PM domain providers. */
static LIST_HEAD(fwnode_genpd_providers);
/* Mutex to protect the list above. */
static DEFINE_MUTEX(fwnode_genpd_mutex);

/**
 * fwnode_genpd_xlate_onecell() - Xlate for one-cell PM domain providers
 * @args: fwnode reference args containing the domain index
 * @data: xlate function private data - pointer to genpd_onecell_data
 */
...
/**
 * fwnode_genpd_add_provider_onecell() - Register a onecell fwnode PM domain provider
 * @fwnode: fwnode associated with the PM domain provider.
 * @data: Pointer to the data associated with the PM domain provider.
 */
...
/**
 * fwnode_genpd_del_provider() - Remove a previously registered fwnode PM domain provider
 * @fwnode: fwnode handle associated with the PM domain provider
 */
...
#endif /* CONFIG_ARM_SCMI_SUPPORT_DT_ACPI */
