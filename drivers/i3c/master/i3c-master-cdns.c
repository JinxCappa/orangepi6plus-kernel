...
static const struct acpi_device_id cdns_i3c_acpi_ids[] = {
	{ "CDNS0034", (kernel_ulong_t)&cdns_i3c_devdata },
	{ /* sentinel */ },
};
...
static const struct dev_pm_ops cdns_i3c_pm_ops = {
	SET_SYSTEM_SLEEP_PM_OPS(cdns_i3c_suspend, cdns_i3c_runtime_resume)
	SET_RUNTIME_PM_OPS(cdns_i3c_runtime_suspend, cdns_i3c_runtime_resume, NULL)
};
