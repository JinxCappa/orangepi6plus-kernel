...
static int
mipi_dphy_rx_get_frame_interval(struct v4l2_subdev *sd,
				...
				struct v4l2_subdev_frame_interval *interval)
{
	...
	return v4l2_subdev_call(remote_sd, pad, get_frame_interval, NULL, interval);
}

static int
mipi_dphy_rx_set_frame_interval(struct v4l2_subdev *sd,
				struct v4l2_subdev_state *state,
				struct v4l2_subdev_frame_interval *interval)
{
	struct dphy_rx *dphy = v4l2_subdev_to_dphy_rx(sd);
	...
	return v4l2_subdev_call(remote_sd, pad, set_frame_interval, NULL, interval);
}
...
static const struct v4l2_subdev_pad_ops mipi_dphy_rx_pad_ops = {
	...
	.get_frame_interval = mipi_dphy_rx_get_frame_interval,
	.set_frame_interval = mipi_dphy_rx_set_frame_interval,
};
...
static void mipi_dphy_rx_remove(struct platform_device *pdev)
{
