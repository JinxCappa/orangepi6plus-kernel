...
#define CDNS_PCIE_LM_RP_RID	(CDNS_PCIE_IP_REG_BANK_BASE + 0x0228)
...
#define CDNS_PCIE_LM_EP_ID	(CDNS_PCIE_IP_REG_BANK_BASE + 0x022c)
...
#define CDNS_PCIE_AT_OB_REGION_DESC0_DEVFN_MASK		GENMASK(26, 24)
